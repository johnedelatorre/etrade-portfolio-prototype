...
exports.read = function(req, res) {
    ...
    function addMarketDataToPosition(callback) {
        req.positionsInAccount.forEach(function(position, index, array) {
            var data = ['companyName', 'lastTrade', 'changeClose', 'changeClosePercentage', 'totalVolume', 'bid', 'ask', 'low', 'high', 'high52', 'low52', 'dividend', 'exDividendDate', 'dividendPayableDate'];
