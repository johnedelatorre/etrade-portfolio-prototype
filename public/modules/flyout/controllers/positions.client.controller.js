'use strict';
angular.module('flyout').controller('PositionsController', ['$scope',
    function($scope) {
    $scope.templates = [{
        name: 'All Positions',
        ...
        fields: ['allStar', 'dividendYield', 'fundCategory', 'morningStar', 'netAssetValue', 'netExpenseRatio', 'totalNetAssets', 'pricePaidPerShare','quantity','totalGainDollar','value'],
        type: 'default'
    }, {
        name: 'Bonds',
